...
/**
 * Portal license validator for ETechFlow_BackInStockNotification.
 *
 *   isValid() priority:
...
class LicenseValidator
{
    ...
    public const XML_PATH_PORTAL_API_URL         = 'etechflow_bisn/license/portal_api_url';
    ...
    private const CACHE_TTL_VALID  = 60;     // portal said valid → recheck within 1 minute so admin IP-removal propagates fast
    ...
    /**
     * Browser-facing portal base, used by the admin licensing controllers to
     * build sign-up / checkout links. Not consulted by isValid().
     */
     ...
     * and CLI for an informational hint — it is deliberately NOT consulted by
     * isValid(), so it can never grant a licensing bypass. Ships no secret.
     */
    ...
    private function isExplicitlyRevoked(): bool
    {
        return (string) $this->scopeConfig->getValue(
            'etechflow_bisn/license/revoked',
